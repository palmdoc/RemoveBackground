...
<main class="vcard">
    <button class="share-btn" type="button" data-share-url="<?= escape($shareUrl) ?>">⋯</button>
    ...
    <section class="icon-grid">
        ...
        <?php if ($card['whatsapp'] !== ''): ?>
            <a class="icon-item" href="https://wa.me/<?= escape($card['whatsapp']) ?>" target="_blank">
        ...
        <?php foreach ($card['links'] as $index => $link): ?>
            <a class="icon-item" href="<?= escape($link) ?>" target="_blank">
